...
CREATE TABLE `form` (
  ...
  `choose_mangoes` varchar(200) NOT NULL,
...
INSERT INTO `form` (`id`, `name`, `district`, `phone`, `amount`, `choose_mangoes`, `course_id`) VALUES
...
INSERT INTO `list` (`id`, `title`, `content`, `level`, `prerequisite`, `duration`) VALUES
